...
class Bot:
    ...
    def __init__(self):
        ...
        # Request live data
        self.ib.reqRealTimeBars(0, contract0, 5, "ASK", True, [])
        self.ib.reqRealTimeBars(1, contract1, 5, "BID", True, [])
    ...
    def on_bar_update(self, reqId, time, open_, high, low, close, volume, wap, count):
        ...
        if STime == LTime:
            ...
            if ratio > 0.006:
                ...
                # Execuate order
                os.system('buyLambdaSellS.py & positionToClose.py')
                #os.system('positionToClose.py')
